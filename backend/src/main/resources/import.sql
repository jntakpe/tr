...
INSERT INTO employee (login, email, first_name, last_name, department, phone, location, password, last_ldap_check, created_by, created_date) VALUES ('jntakpe', 'jocelyn.ntakpe@soprasteria.com', 'Jocelyn', 'N''takpe', '512 SF CRÉDIT AGRICOLE LBP BDF', '5 1394', 'TOULOUSE COLO 1 - B1&B2', '$2a$10$VXqsdFTF802HGOoaA/dO/ehomvjEItM8HabUIU1.TaDUEt5fMMnR2', CURRENT_TIMESTAMP, 'jntakpe', CURRENT_TIMESTAMP);
INSERT INTO employee (login, email, first_name, last_name, department, phone, location, password, last_ldap_check, created_by, created_date) VALUES ('gpeel', 'gauthier.peel@soprasteria.com', 'Gauthier', 'Peel', '042 DRH FORMATION ET DÉVELOPPEMENT', '4 7629', 'AIX PICHAURY', '$2a$10$VXqsdFTF802HGOoaA/dO/ehomvjEItM8HabUIU1.TaDUEt5fMMnR2', CURRENT_TIMESTAMP, 'jntakpe', CURRENT_TIMESTAMP);
