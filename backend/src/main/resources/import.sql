...
INSERT INTO session (start, location_id, training_id, trainer_id, created_by, created_date) VALUES ('2013-12-12', (SELECT id FROM location WHERE name = 'matei' AND city='Paris'), (SELECT id FROM training WHERE name='spring'), (SELECT id FROM employee WHERE login='gpeel'), 'gpeel', CURRENT_TIMESTAMP);
...
INSERT INTO session (start, location_id, training_id, trainer_id, created_by, created_date) VALUES ('2012-10-10', (SELECT id FROM location WHERE name = 'colo1' AND city='Toulouse'), (SELECT id FROM training WHERE name='angularJS'), (SELECT id FROM employee WHERE login='jntakpe'), 'jntakpe', CURRENT_TIMESTAMP);
INSERT INTO session (start, location_id, training_id, trainer_id, created_by, created_date) VALUES ('2013-10-10', (SELECT id FROM location WHERE name = 'colo1' AND city='Toulouse'), (SELECT id FROM training WHERE name='angularJS'), (SELECT id FROM employee WHERE login='jntakpe'), 'jntakpe', CURRENT_TIMESTAMP);
