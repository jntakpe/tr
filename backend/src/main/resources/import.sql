...
-- Table Employee
INSERT INTO employee (login, email, first_name, last_name, department, phone, location, trainer, password, last_ldap_check, created_by, created_date) VALUES ('jntakpe', 'jocelyn.ntakpe@soprasteria.com', 'Joss', 'N''takpe', '512 SF CRÉDIT AGRICOLE LBP BDF', '5 1394', 'TOULOUSE COLO 1 - B1&B2', true, '$2a$10$LH5vuBPe8OcsZ7nBwg7LpuRKGeaBZjdrfC6e6KME9fKn.fyzeldse', CURRENT_TIMESTAMP, 'jntakpe', CURRENT_TIMESTAMP);
INSERT INTO employee (login, email, first_name, last_name, department, phone, location, trainer, password, last_ldap_check, created_by, created_date) VALUES ('gpeel', 'gauthier.peel@soprasteria.com', 'Gauthier', 'Peel', '042 DRH FORMATION ET DÉVELOPPEMENT', '4 7629', 'AIX PICHAURY', true, '$2a$10$LH5vuBPe8OcsZ7nBwg7LpuRKGeaBZjdrfC6e6KME9fKn.fyzeldse', CURRENT_TIMESTAMP, 'jntakpe', CURRENT_TIMESTAMP);
INSERT INTO employee (login, email, first_name, last_name, department, phone, location, trainer, password, last_ldap_check, created_by, created_date) VALUES ('sbourret', 'sebastien.bourret@soprasteria.com', 'Sébastien', 'Bourret', '112 LYON INDUSTRIE', '4 5572', 'LYON LIMONEST', true, '$2a$10$VXqsdFTF802HGOoaA/dO/ehomvjEItM8HabUIU1.TaDUEt5fMMnR2', '2015-01-01 00:00:00.751000', 'jntakpe', CURRENT_TIMESTAMP);
INSERT INTO employee (login, email, first_name, last_name, department, phone, location, trainer, password, last_ldap_check, created_by, created_date) VALUES ('jguerrin', 'julien.guerrin@soprasteria.com', 'Julien', 'Guerrin', '512 SF CRÉDIT AGRICOLE LBP BDF', '', 'TOULOUSE COLO 1 - B1&B2', false, '$2a$10$VXqsdFTF802HGOoaA/dO/ehomvjEItM8HabUIU1.TaDUEt5fMMnR2', CURRENT_TIMESTAMP, 'jntakpe', CURRENT_TIMESTAMP);
